...
export const allCards = [
  ...
  Card("Card_0038_bake.png", 0, "Buff", "Tin Man", 4),
  Card("Card_0051_bake.png", 3, "Buff", "Card Profaner", 4),
  Card("Card_0064_bake.png", 0, "Companion", "Sticky Bomb", 1),
  ...
  Card("Card_0041_bake.png", 0, "Companion", "Wall", 1),
  ...
  Card("Card_0124_bake.png", 5, "Companion", "Dr. MoleBOT", 1),
  ...
  Card("Card_0042_bake.png", 0, "Companion", "Bomb Belt", 2),
  Card("Card_0057_bake.png", 0, "Companion", "Land Mine", 1),
  Card("Card_0068_bake.png", 0, "Companion", "Toxic Bomb", 2),
  ...
  Card("Card_0058_bake.png", 0, "Companion", "Bear Trap", 1),
  ...
  Card("Card_0033_bake.png", 0, "Companion", "CA-Turret", 2),
  Card("Card_0046_bake.png", 0, "Companion", "Ice Block", 1),
  Card("Card_0059_bake.png", 0, "Buff", "Invisible", 3),
  Card("Card_0070_bake.png", 0, "Debuff", "Swap Weapons", 3),
  Card("Card_0088_bake.png", 0, "Companion", "Kaboomber", 2),
  Card("Card_0102_bake.png", 0, "Trap", "Self-destruct Device", 3),
  Card("Card_0137_bake.png", 5, "Companion", "Teleport Bomb", 1),
  ...
  Card("Card_0047_bake.png", 4, "Companion", "Bouncy Wall", 2),
  ...
  Card("Card_0104_bake.png", 0, "Companion", "Karratov", 2),
  ...
  Card("Card_0048_bake.png", 0, "Companion", "Smoke Bomb", 1),
  ...
  Card("Card_0109_bake.png", 0, "Wild", "Parlay", 3),
  ...
  Card("Card_0049_bake.png", 0, "Companion", "Flash Bomb", 1),
  Card("Card_0062_bake.png", 0, "Wild", "Nuke", 2),
  ...
  Card("Card_0037_bake.png", 0, "Companion", "Bomb", 1),
  ...
  .map((batch) => batch.sort((a, b) => a.id - b.id))
  .flat(1)
